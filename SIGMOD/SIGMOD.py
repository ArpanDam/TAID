...
if(len(sys.argv) != 3):
    ...
    k=4 # Number of influence tags
    r=5  # Number of Influencial users    
...
value=generate_original_graph_for_input2.give_r_percentile(reverse_graph)
pos_reverse_graph=generate_original_graph_for_input.generate_positive_graph(reverse_graph) # correct

iteration=1

print("For number of influencial users = ",k,"number of influence tags= ",r)
